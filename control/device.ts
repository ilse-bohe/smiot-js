...
export class Device {
    ...
    monitorParameter(parameterReference: string, onNewValue: Function, onError?: Function) {
        ...
        //     }
        // );
        var tempSubscription = this.engine.performMonitor(parameter.actions[Action.Monitor].replaceDynamicValues(this.configurations.settings)).subscribe(onNewValue, onError);
